...
function WelcomeRedirect() {
  ...
  useEffect(() => {
    ...
    // If query params exist, store them in sessionStorage and redirect
    ...
    // Redirect to route-based welcome page
    const layoutRoute = eventSize === '4x6' ? '/session/landscape/welcome' : '/session/strip/welcome';
