...
export default function SetupPage() {
  return (
    <main className="flex min-h-dvh flex-col items-center justify-start bg-background text-foreground p-4 sm:p-8 pt-16">
            ...
            <Card className="h-full flex flex-col group hover:ring-2 hover:ring-primary transition-all">
              ...
              <CardContent className="flex-grow flex flex-col justify-between">
                <div className="relative w-full aspect-video rounded-md overflow-hidden bg-muted mb-4">
                  <Image
                    src="/templates/landscape/century_layout.png"
                    alt="4x6 landscape postcard template"
                    fill
